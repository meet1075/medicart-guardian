...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-BtG4vr6A.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BErKBjWy.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-KExUNKCg.mjs"),
		import("./start-CqMfSSyQ.mjs"),
