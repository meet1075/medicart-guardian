...
//#region node_modules/.nitro/vite/services/ssr/assets/admin-xr7dJP2t.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var $$splitComponentImporter = () => import("./admin-D-euY4GN.mjs");
var Route = createFileRoute("/admin")({
	head: () => ({ meta: [{ title: "MediCart — Admin" }, {
		name: "robots",
		content: "noindex"
	}] }),
...
//#endregion
export { Route as n, AdminChrome as t };
